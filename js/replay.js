...
export function recordFrame(buffer, gameState, direction) {
    var snapshot = {
        ...
        walls: gameState.walls ? gameState.walls.map(function(w) { return { x: w.x, y: w.y }; }) : [],
        obstacles: gameState.obstacles ? gameState.obstacles.map(function(o) { return Object.assign({}, o); }) : [],
        portals: gameState.portals ? gameState.portals.map(function(p) { return Object.assign({}, p); }) : [],
        powerUp: gameState.powerUp ? Object.assign({}, gameState.powerUp) : null,
        activePowerUp: gameState.activePowerUp ? Object.assign({}, gameState.activePowerUp) : null,
        hunter: gameState.hunter ? Object.assign({}, gameState.hunter, {
            segments: gameState.hunter.segments ? gameState.hunter.segments.map(function(s) { return { x: s.x, y: s.y }; }) : [],
        }) : null,
