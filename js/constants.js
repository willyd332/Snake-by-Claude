...
export var LEVEL_CONFIG = {
    ...
    6: { speed: 90,  color: '#e11d48', foodColor: '#fbbf24', wallColor: '#4a1a2e', bgAccent: '#0a0508', gridAlpha: 0.02, obstacleColor: '#be123c', portalColor: '#a855f7', fogRadius: 5, wrapAround: false, powerUpsEnabled: false },
    ...
    10: { speed: 75, color: '#e2e8f0', foodColor: '#ff4444', wallColor: '#475569', bgAccent: '#080810', gridAlpha: 0.02, obstacleColor: '#64748b', portalColor: '#f472b6', fogRadius: 4, wrapAround: false, powerUpsEnabled: true, hunterEnabled: true, hunterColor: '#ff6600', hunterTickInterval: 2, shrinkingArena: true, shrinkInterval: 4 },
};
